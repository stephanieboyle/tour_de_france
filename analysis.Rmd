...
# PATCHWORK BIT
big_plot <- winners_plot + teams_plot + countries_plot + distances_plot + timings_plot + speed_plot + stage_wins_plot + stage_leads_plot + start_plot + end_plot + stage_types_plot + stage_distance_plot + stage_type_plot
